...
import com.host3030.model.Category;
...
public class StudentCrud_1 extends TestBase1 {

    int IdNumber;
    static String firstName = "Dhaval"+ TestUtils.getRandomValue();
    static String lastname = "Patel" + TestUtils.getRandomValue();
    static String programme = "Sciences Biology";
